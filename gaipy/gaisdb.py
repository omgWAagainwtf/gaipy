import requests
import json
from .basic import __return, __parse_column_args
from .basic import __build_query, __parse_to_gaisrec
...
def Select(db, pattern={}, filter_args={}, mode='', page_cnt=10, page=1, order_by='', order='decreasing'):
    ...
    if page_cnt < 1:
        ...
        if order is 'increasing' or order is 'asc':
